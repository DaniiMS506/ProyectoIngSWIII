...
VALUES ('Juan', 'Perez', 'juan@example.com', 'password123', 1),
...
VALUES ('Carlos', 'Gonzalez', 'carlos@gmail.com', 123456789, 'Calle Principal 123'),
...
VALUES ('Medicamentos', 'Productos relacionados con la salud'),
...
INSERT INTO Producto (Nombre_producto, Descripcion, Precio, Fecha_expiracion, Id_categoria)
VALUES ('Paracetamol', 'Analgesico y antipiretico', 5.99, '2025-06-30', 1),
       ('Shampoo', 'Para cabello seco', 8.50, '2024-12-31', 2),
       ('Arroz', 'Grano blanco, 1kg', 3.25, '2024-10-15', 3),
       ('Smartphone', 'Android de gama media', 299.99, NULL, 4),
       ('Camiseta', 'Algodon, talla M', 12.99, NULL, 5);

-- Inserts para la tabla Pedido
INSERT INTO Pedido (Id_cliente, Fecha_pedido, Estado, Total)
VALUES (1, '2024-07-16 10:30:00', 'pendiente', 25.50),
...
VALUES ('Distribuidora A', 'Avenida Libertad 123', 123456789, 'contacto@distribuidoraA.com'),
