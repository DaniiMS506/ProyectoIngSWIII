...
<body>
    <header class="header">
        <h1>TecnoFarma - Proveedor <i class="fa fa-user-secret"></i> </h1>
    </header>
    ...
    <nav class="navbar">
        <ul>
            ...
            <li><a href="ProveedorAdmin.php" class="active fa fa-group"> Proveedor</a></li>
        ...
        <div class="container_registro">
            ...
            <form action="" class="form-control formulario_registro" id="form-control" method="post" enctype="multipart/form-data">
                ...
                <div class="accordion" id="accordionExample">
                    ...
                    <!--Accordion 1 Registrar Proveedor-->
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button type="submit" class="btn btn-dark" id="btn_RegistrarProveedor" style="margin-top: 15px;">Agregar</button>
    ...
    <h2 id="tituloProd">Tabla de Proveedor</h2>
...
<!-- JS -->
<script src="../JS/ProveedorAdmin.js"></script>