...
while ($row = mysqli_fetch_array($result)) {
    $tabla .= "
        <tr>
            ...
            <td id=\"contenedor\"> 
            <abbr title=\"Editar\"><button class=\"btn btn_danger\" onclick=\"cargarDatosParaEditar('" . $row["Id_detalle"] . "')\" style='border-color:#0B7DE1; border-radius: 12px;' class='btn' >  <i class=\"fa fa-pencil-square-o\" style='color:#238ce8; font-weight: bold;'> </i> </button></abbr>
                <abbr title=\"Eliminar\"><button class=\"btn btn_danger\" onclick=\"eliminarDetallePedido(" . $row["Id_detalle"] . ")\" style='border-color:#D60404; border-radius: 12px;' class='btn' >  <i class=\"fa fa-trash\" style='color:#D60404; font-weight: bold;'> </i> </button></abbr>
            </td>
        </tr>";
}
